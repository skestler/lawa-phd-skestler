...
#ifndef LAWA_CONSTRUCTIONS_INTERVAL_MULTI__CUBIC_EVALUATOR_H
#define LAWA_CONSTRUCTIONS_INTERVAL_MULTI__CUBIC_EVALUATOR_H 1
...
template <typename T>
    T
    _cubic_bspline_left_evaluator0(T x, unsigned short deriv);

template <typename T>
    T
    _cubic_bspline_right_evaluator0(T x, unsigned short deriv);
...
template <typename T>
    T
    _cubic_wavelet_left_evaluator0(T x, unsigned short deriv);
...
template <typename T>
    T
    _cubic_wavelet_right_evaluator0(T x, unsigned short deriv);
...
#endif // LAWA_CONSTRUCTIONS_INTERVAL_MULTI__CUBIC_EVALUATOR_H
