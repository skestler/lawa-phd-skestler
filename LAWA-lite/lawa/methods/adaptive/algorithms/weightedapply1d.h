...
#ifndef  LAWA_METHODS_ADAPTIVE_ALGORITHMS_WEIGHTEDAPPLY1D_H
#define  LAWA_METHODS_ADAPTIVE_ALGORITHMS_WEIGHTEDAPPLY1D_H 1
...
#include <lawa/methods/adaptive/algorithms/weightedapply1d.tcc>
