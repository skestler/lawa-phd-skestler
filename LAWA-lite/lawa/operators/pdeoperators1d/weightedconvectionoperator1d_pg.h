...
class WeightedConvectionOperator1D_PG{
    ...
    public:
        ...
        WeightedConvectionOperator1D_PG(const TrialBasis& _trialbasis, const TestBasis& _testbasis, Function<T> weightFct);
    ...
    private:
        ...
        IntegralF<Quad, TestBasis, TrialBasis> integral;

};

} // namespace lawa

#include <lawa/operators/pdeoperators1d/weightedconvectionoperator1d_pg.tcc>

#endif  // LAWA_OPERATORS_PDEOPERATORS1D_WEIGHTEDCONVECTIONOPERATOR1D_PG_H
