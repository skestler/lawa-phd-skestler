...
OptionRHS1D<T, Put, CGMY, Basis1D>::OptionRHS1D(const OptionParameters1D<T,Put> &_optionparameters,
...
template <typename T, typename Basis1D>
T
OptionRHS1D<T, Put, CGMY, Basis1D>::operator()(XType xtype, int j, int k) const
{
...
template <typename T, typename Basis1D>
T
OptionRHS1D<T, Put, CGMY, Basis1D>::operator()(T time, XType xtype, int j, int k) const
{
...
template <typename T, typename Basis1D>
T
OptionRHS1D<T, Put, CGMY, Basis1D>::operator()(const Index1D &lambda) const
{
...
template <typename T, typename Basis1D>
T
OptionRHS1D<T, Put, CGMY, Basis1D>::operator()(T time, const Index1D &lambda) const
{
    return this->operator()(lambda.xtype, lambda.j, lambda.k);
}
