...
#ifndef APPLICATIONS_FINANCE_OPERATORS_CGMYEOPERATOR1D_H
#define APPLICATIONS_FINANCE_OPERATORS_CGMYEOPERATOR1D_H 1
...
#include <applications/finance/operators/cgmyeoperator1d.tcc>
