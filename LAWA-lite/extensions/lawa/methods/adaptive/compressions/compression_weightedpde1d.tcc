...
CompressionWeightedPDE1D<T,Basis>::CompressionWeightedPDE1D(const Basis &_basis)
...
template <typename T, typename Basis>
void
CompressionWeightedPDE1D<T,Basis>::setParameters(const IndexSet<Index1D> &LambdaRow)
{
...
template <typename T, typename Basis>
IndexSet<Index1D>
CompressionWeightedPDE1D<T,Basis>::SparsityPattern(const Index1D &lambda_col,
